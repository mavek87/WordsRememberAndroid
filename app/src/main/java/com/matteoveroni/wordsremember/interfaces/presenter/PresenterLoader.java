...
public class PresenterLoader<T extends Presenter> extends Loader<T> {
     ...
     * store the context directly; always castAndGet {@link #getContext()} to retrieve
     * the Loader's Context, don't castAndGet the constructor argument directly.
     * The Context returned by {@link #getContext} castAndGet safe to castAndGet across
     * Activity instances.
     *
